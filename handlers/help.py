...
BANNER_PHOTO_ID = os.getenv("BANNER_PHOTO_ID") # Pastikan BANNER_PHOTO_ID ada di .env

def get_help_keyboard() -> InlineKeyboardMarkup:
    """ Keyboard navigasi untuk menu Bantuan """
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="💬 Hubungi Admin", url="https://t.me/UsernameAdminAnda")], # Ganti dengan username admin/support
...
async def cmd_help(message: types.Message):
    help_text = (
        ...
        "• <b>Keunggulan VIP/VIP+:</b> Kuota posting lebih banyak, bisa kirim DM langsung, buka topeng anonim (Unmask), dan bebas <i>chat</i> di Grup Publik.\n"
